...
/**
 * Vercel serverless functions have no writable persistent disk, so schema.json
 * and the uploaded images both live in Vercel Blob storage instead of the local
 * `./db` folder the original app used.
 */
